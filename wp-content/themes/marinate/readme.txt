...
**Font License
Applies to all desktop and webfont files in the following directory: marinate/fonts/.
License: SIL OFL 1.1
URL: http://scripts.sil.org/OFL

**Code License
Applies to all CSS in the following file: marinate/css/font-awesome.css.
License: MIT License
...
* Pushy
Copyright (c) 2018 Christopher Yee
...
https://pixabay.com/en/mountain-road-winding-road-travel-1556177/ - CC0 Creative Commons
https://pixabay.com/en/food-meals-foodie-tables-dinner-3020282/ - CC0 Creative Commons
...
https://pixabay.com/en/vacation-beach-sea-ocean-pool-2217498/ - CC0 Creative Commons

== Changelog ==

1.0.0 = Initital Release
1.0.1 = Fixed Container width and added custom columns in archive pages.
1.0.2 = Fixed post parkup issues
