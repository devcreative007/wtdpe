...
?>
    ...
    $comment_arg = array(
        ...
        'comment_field' =>  '<p class="comment-form-comment"><label for="comment">'.__('Comment', 'marinate').'</label><textarea id="comment" class="form-control" name="comment" placeholder="' .esc_html('Leave your comment here...', 'marinate'). '" cols="45" rows="10" required="required" aria-required="true">' .
            '</textarea></p>',
