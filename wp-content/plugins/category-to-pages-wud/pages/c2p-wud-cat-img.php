<?php
if ( ! class_exists( 'CAT_TO_PAGE_WUD_IMGS' ) ) {

class CAT_TO_PAGE_WUD_IMGS {
 ...
 */
 public function init() {
	if( get_option('cattopage_wud_cat_img') == 0 ){
		return;
	}	 
...
$CAT_TO_PAGE_WUD_IMGS = new CAT_TO_PAGE_WUD_IMGS();
$CAT_TO_PAGE_WUD_IMGS -> init();
